...
Este curso de **1 hora** introduce a estudiantes de secundaria a la **creación de sitios web básicos** utilizando **HTML y CSS**.  
**¡No requiere descargas ni instalación!** Solo necesitas tu navegador web.
